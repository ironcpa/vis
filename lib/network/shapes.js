...
if (typeof CanvasRenderingContext2D !== 'undefined') {
   ...
   * @param {number} size   size, width and height of the box
   */
  CanvasRenderingContext2D.prototype.box = function (x, y, size) {
    this.beginPath();
   ...
   * @param {number} x horizontal center
   * @param {number} y vertical center
   * @param {number} w width of groupBox
   * @param {number} h height of groupBox
   */
  CanvasRenderingContext2D.prototype.groupBox = function (x, y, w, h) {
    this.beginPath();
