...
let allOptions = {
  ...
  nodes: {
    ...
    shape: { string: ['ellipse', 'circle', 'database', 'box', 'text', 'image', 'circularImage', 'diamond', 'dot', 'star', 'triangle', 'triangleDown', 'square', 'groupBox', 'icon', 'hexagon'] },
    shapeProperties: {
...
let configureOptions = {
  nodes: {
    ...
    shape: ['ellipse', 'box', 'circle', 'database', 'diamond', 'dot', 'square', 'groupBox', 'star', 'text', 'triangle', 'triangleDown','hexagon'],
    shapeProperties: {
      borderDashes: false,
