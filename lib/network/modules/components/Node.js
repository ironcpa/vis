...
var GroupBox = require('./nodes/shapes/GroupBox').default;
...
class Node {
    ...
    if (currentShape === this.options.shape && this.shape) {
      ...
      switch (this.options.shape) {
        ...
        case 'square':
          ...
          break;
        case 'groupBox':
          this.shape = new GroupBox(this.options, this.body, this.labelModule);
          break;
        case 'hexagon':
  ...
  /**
   * Check if this object is inside of the provided object
   * @param {Object} obj   an object with parameters left, top, right, bottom
   * @return {boolean}     True if location is in node
   */
  isIn(obj) {
    return (
      this.shape.left > obj.left &&
      this.shape.left + this.shape.width < obj.left + obj.width &&
      this.shape.top > obj.top &&
      this.shape.top + this.shape.height < obj.top + obj.height
    );
  }
